...
img = setting.img
baper = 'SUB YT MR.R'
apiku = 'https://api-key-revolt.herokuapp.com//'
gc_wa_lu = 'https://chat.whatsapp.com/KBt8lh74kvUJ6gunrVkco4' //klo gk punya gc wa gk usah di ganti 👍
...
await alpha.updatePresence(from, Presence.composing)
	...
	return admins
		...
		const alphaNumber = [`6283164445159@s.whatsapp.net`]
